...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PortalApi.BuildReportText = factory(root.PortalApi.ApiClient);
  }
  ...
  /**
   * The BuildReportText model module.
   * @module model/BuildReportText
   * @version v1
   */

  /**
   * Constructs a new <code>BuildReportText</code>.
   * @alias module:model/BuildReportText
   * @class
   */
  ...
  /**
   * Constructs a <code>BuildReportText</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BuildReportText} obj Optional instance to populate.
   * @return {module:model/BuildReportText} The populated <code>BuildReportText</code> instance.
   */
